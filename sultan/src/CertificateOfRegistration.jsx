...
const CertificateOfRegistration = () => {
  ...
  const totalLec = filteredData.reduce((acc, item) => acc + (item.lec || 0), 0);
  const totalLab = filteredData.reduce((acc, item) => acc + (item.lab || 0), 0); 
  const totalCredit = filteredData.reduce((acc, item) => acc + (item.credit || 0), 0);
  const totalTuition = filteredData.reduce((acc, item) => acc + (item.tuition || 0), 0);


  useEffect(() => {
    const fetchItems = async () => {
      try {
        const response = await axios.get("http://localhost:5000/api/registration"); // Replace with your API endpoint
            ...
            <tbody>
              ...
              <tr>
                ...
                >
                  <input
                    type="text"
                    value={"aujscsultannorodeen@gmail.com"}
                    readOnly
                    style={{
                      color: "black",
                      width: "98%",
              ...
              {filteredData.map((item, index) => (
                <tr key={index}>
                  ...
                  <td colSpan={1} style={{ height: "0.25in", fontSize: "62.5%", border: "1px solid black" }}>
                    <input
                      type="text"
                      value={item.lec !== null && item.lec !== undefined ? item.lec : ""}
                      readOnly
                      style={{
                        color: "black",
                        width: "98%",
                  ...
                  <td colSpan={1} style={{ height: "0.25in", fontSize: "62.5%", border: "1px solid black" }}>
                    <input
                      type="text"
                      value={item.lab !== null && item.lab !== undefined ? item.lab : ""}
                      readOnly
                      style={{
                        color: "black",
                        width: "98%",
                  ...
                  <td colSpan={1} style={{ height: "0.25in", fontSize: "62.5%", border: "1px solid black" }}>
                    <input
                      type="text"
                      value={item.credit !== null && item.credit !== undefined ? item.credit : ""}
                      readOnly
                      style={{
                        color: "black",
                        width: "98%",
                  ...
                  <td colSpan={1} style={{ height: "0.25in", fontSize: "62.5%", border: "1px solid black" }}>
                    <input
                      type="text"
                      value={item.tuition !== null && item.tuition !== undefined ? item.tuition : ""}
                      readOnly
                      style={{
                        color: "black",
                        width: "98%",
